...
/// Reads [file], replaces all instances of SASS_MIGRATOR_VERSION with the
/// actual version, and returns its contents.
String readAndReplaceVersion(String file) =>
    File(file).readAsStringSync().replaceAll("SASS_MIGRATOR_VERSION", version);
